...
define config.name = _("Steel Souls")
...
define config.main_menu_music = "gui/TitleMusic.mp3"
...
define config.save_directory = "Steel Souls-1565029140"
